//#region node_modules/@babylonjs/havok/lib/esm/HavokPhysics_es.js
var HavokPhysics = (() => {
	...
	return (function(moduleArg = {}) {
		...
		function findWasmBinary() {
			...
			return new URL("../../@babylonjs/havok/lib/esm/HavokPhysics.wasm", import.meta.url).href;
		}
		var wasmBinaryFile;
		...
		var __embind_register_bigint = (primitiveType, name, size, minRange, maxRange) => {
			...
			if (isUnsignedType) maxRange = (1n << 64n) - 1n;
			registerType(primitiveType, {
				name,
				fromWireType: (value) => value,
				toWireType: function(destructors, value) {
					if (typeof value != "bigint" && typeof value != "number") throw new TypeError(`Cannot convert "${embindRepr(value)}" to ${this.name}`);
		...
		var InvokerFunctions = {
			ftf: function(humanName, throwBindingError, invoker, fn, runDestructors, retType, classParam) {
				return function() {
					var rv = invoker(fn);
					return retType["fromWireType"](rv);
				};
			},
			ftfn: function(humanName, throwBindingError, invoker, fn, runDestructors, retType, classParam, argType0) {
				return function(arg0) {
					var rv = invoker(fn, argType0["toWireType"](null, arg0));
					return retType["fromWireType"](rv);
				};
			},
			fffn: function(humanName, throwBindingError, invoker, fn, runDestructors, retType, classParam, argType0) {
				return function(arg0) {
					invoker(fn, argType0["toWireType"](null, arg0));
				};
			},
			ftfnnnn: function(humanName, throwBindingError, invoker, fn, runDestructors, retType, classParam, argType0, argType1, argType2, argType3) {
				return function(arg0, arg1, arg2, arg3) {
					var rv = invoker(fn, argType0["toWireType"](null, arg0), argType1["toWireType"](null, arg1), argType2["toWireType"](null, arg2), argType3["toWireType"](null, arg3));
					return retType["fromWireType"](rv);
				};
			},
			ftfnn: function(humanName, throwBindingError, invoker, fn, runDestructors, retType, classParam, argType0, argType1) {
				return function(arg0, arg1) {
					var rv = invoker(fn, argType0["toWireType"](null, arg0), argType1["toWireType"](null, arg1));
					return retType["fromWireType"](rv);
				};
			},
			ftftt: function(humanName, throwBindingError, invoker, fn, runDestructors, retType, classParam, argType0, argType1, arg0Wired_dtor, arg1Wired_dtor) {
				return function(arg0, arg1) {
			...
			ftft: function(humanName, throwBindingError, invoker, fn, runDestructors, retType, classParam, argType0, arg0Wired_dtor) {
				return function(arg0) {
					var arg0Wired = argType0["toWireType"](null, arg0);
			...
			ftftn: function(humanName, throwBindingError, invoker, fn, runDestructors, retType, classParam, argType0, argType1, arg0Wired_dtor) {
				return function(arg0, arg1) {
					var arg0Wired = argType0["toWireType"](null, arg0);
					var rv = invoker(fn, arg0Wired, argType1["toWireType"](null, arg1));
					arg0Wired_dtor(arg0Wired);
					return retType["fromWireType"](rv);
				};
			},
			ftftnn: function(humanName, throwBindingError, invoker, fn, runDestructors, retType, classParam, argType0, argType1, argType2, arg0Wired_dtor) {
				return function(arg0, arg1, arg2) {
					var arg0Wired = argType0["toWireType"](null, arg0);
					var rv = invoker(fn, arg0Wired, argType1["toWireType"](null, arg1), argType2["toWireType"](null, arg2));
					arg0Wired_dtor(arg0Wired);
					return retType["fromWireType"](rv);
				};
			},
			ftfttn: function(humanName, throwBindingError, invoker, fn, runDestructors, retType, classParam, argType0, argType1, argType2, arg0Wired_dtor, arg1Wired_dtor) {
				return function(arg0, arg1, arg2) {
					var arg0Wired = argType0["toWireType"](null, arg0);
					var arg1Wired = argType1["toWireType"](null, arg1);
					var rv = invoker(fn, arg0Wired, arg1Wired, argType2["toWireType"](null, arg2));
					arg0Wired_dtor(arg0Wired);
					arg1Wired_dtor(arg1Wired);
					return retType["fromWireType"](rv);
				};
			},
			ftfttt: function(humanName, throwBindingError, invoker, fn, runDestructors, retType, classParam, argType0, argType1, argType2, arg0Wired_dtor, arg1Wired_dtor, arg2Wired_dtor) {
				return function(arg0, arg1, arg2) {
					var arg0Wired = argType0["toWireType"](null, arg0);
					var arg1Wired = argType1["toWireType"](null, arg1);
			...
			ftfnntn: function(humanName, throwBindingError, invoker, fn, runDestructors, retType, classParam, argType0, argType1, argType2, argType3, arg2Wired_dtor) {
				return function(arg0, arg1, arg2, arg3) {
					var arg0Wired = argType0["toWireType"](null, arg0);
					var arg1Wired = argType1["toWireType"](null, arg1);
					var arg2Wired = argType2["toWireType"](null, arg2);
					var rv = invoker(fn, arg0Wired, arg1Wired, arg2Wired, argType3["toWireType"](null, arg3));
					arg2Wired_dtor(arg2Wired);
					return retType["fromWireType"](rv);
				};
			},
			ftftttt: function(humanName, throwBindingError, invoker, fn, runDestructors, retType, classParam, argType0, argType1, argType2, argType3, arg0Wired_dtor, arg1Wired_dtor, arg2Wired_dtor, arg3Wired_dtor) {
				return function(arg0, arg1, arg2, arg3) {
					var arg0Wired = argType0["toWireType"](null, arg0);
					var arg1Wired = argType1["toWireType"](null, arg1);
					var arg2Wired = argType2["toWireType"](null, arg2);
		...
		function createJsInvokerSignature(argTypes, isClassMethodFunc, returns, isAsync) {
			...
			for (let i = isClassMethodFunc ? 1 : 2; i < argTypes.length; ++i) {
				...
				let destructorSig = "";
				if (arg.destructorFunction === void 0) destructorSig = "u";
				else if (arg.destructorFunction === null) destructorSig = "n";
				else destructorSig = "t";
		...
		function craftInvokerFunction(humanName, argTypes, classType, cppInvokerFunc, cppTargetFunc, isAsync) {
			...
			return createNamedFunction(humanName, InvokerFunctions[createJsInvokerSignature(argTypes, isClassMethodFunc, returns, isAsync)](...closureArgs));
		}
		...
		var getStringOrSymbol = (address) => {
			...
			if (symbol === void 0) return readLatin1String(address);
			return symbol;
		};
		...
		var __emval_get_method_caller = (argCount, argTypes, kind) => {
			...
			var invokerFunction = (obj, func, destructorsRef, args) => {
				...
				return emval_returnValue(retType, destructorsRef, kind === 1 ? reflectConstruct(func, argN) : func.apply(obj, argN));
			};
			return emval_addMethodCaller(createNamedFunction(`methodCaller<(${types.map((t) => t.name).join(", ")}) => ${retType.name}>`, invokerFunction));
		};
...
//#endregion
export { HavokPhysics as default };
